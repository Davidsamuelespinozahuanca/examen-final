...
function movimientoopcion5(){
	...
	if(numeroo5 >= 1024) {numeroo5=0}else{numeroo5+=5}

    for (var i = 0; i <= numeroo5; i+=340) {
	  
	    if (numeroo5>=i) {ubicacionxo5 =i}
    }
    if (numero5>=1024) {numero5=0} else {numero5+=5}

    	for (var a = 0; a <=numero5; a+=5) {
...
ctx.drawImage(sprite, ubicacionxo5,0,512,500,ubicacion5,250,300,200);
